...
import { TokenSearch } from "../portfolio/search"
import TokenIcon from "../portfolio/tokenIcon"
...
export default function History() {
  ...
  return (
    <div className="mx-0 mb-10 w-full pt-5">
      <Card
        className={`${Styles.container} w-full rounded-none border-x border-[#181F25]/70 pt-2`}
      >
        <CardContent className="mx-0 border-x border-t border-[#181F25]/70 p-0">
          <Tabs className={Styles.tabs} value="tokens">
            <div className="justify-betweenpx-0 mx-0 mb-0 flex w-full items-center">
                  ...
                  <TableBody>
                    {tokens.map((token) => {
                      ...
                      return (
                        ...
                        >
                          <TableCell>
                            <div className="relative flex size-8 items-center justify-center overflow-hidden rounded-full border border-[#181F25]/70 bg-zinc-900">
