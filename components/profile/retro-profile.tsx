    ...
    <div className="w-full pt-6">
      <div className="flex w-full flex-col items-center md:flex-row">
        ...
        <div className="mt-5 flex md:mt-0 ltr:md:ml-auto rtl:md:mr-auto">
          ...
          >
            <div className="inline-block text-sm font-medium tracking-tighter text-gray-900 ltr:pr-2 rtl:pl-2 dark:text-[#F2F4F3]">
          ...
          <button
            className="cursor-pointer text-gray-500 transition hover:text-gray-900 ltr:pl-6 rtl:pr-6 dark:hover:text-[#F2F4F3]"
