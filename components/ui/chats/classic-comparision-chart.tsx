...
export default function ComparisonChart() {
  ...
  return (
    <div className="light:border light:border-slate-200 rounded-lg bg-[#F2F4F3] p-6 shadow-card dark:bg-light-dark sm:p-8">
          ...
          >
            ...
            <Tooltip
              ...
              cursor={{
                ...
                stroke: theme === "dark" ? "#1F2937" : "rgb(239, 240, 244)",
              }}
              wrapperStyle={{
