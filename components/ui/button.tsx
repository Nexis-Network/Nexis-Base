    ...
    return (
      ...
      >
        {Icon && iconPlacement === "left" && (
          <div className="w-0 translate-x-0 pr-0 opacity-0 transition-all duration-200 group-hover:w-5 group-hover:translate-x-10 group-hover:pr-2 group-hover:opacity-100">
            <Icon />
          </div>
        )}
