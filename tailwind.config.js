  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        'oslo-gray': '#868E96'  // Replace with your desired hex color
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      keyframes: {
        ...
        'border-tl': { '0%, 100%': { width: '8px', height: '8px' }, '50%': { width: '100%', height: '100%' } },
        'border-tr': { '0%, 100%': { width: '8px', height: '8px' }, '50%': { width: '100%', height: '100%' } },
        'border-bl': { '0%, 100%': { width: '8px', height: '8px' }, '50%': { width: '100%', height: '100%' } },
        'border-br': { '0%, 100%': { width: '8px', height: '8px' }, '50%': { width: '100%', height: '100%' } },
      },
      animation: {
      ...
      fontSize: {
        md: '0.9375rem', // or whatever size you want for 'md'
      },
      backgroundColor: {
